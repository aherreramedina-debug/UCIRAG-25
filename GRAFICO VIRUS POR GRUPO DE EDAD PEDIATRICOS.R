...
# ----------------------------------------------------------------
# 4. GRAFICO PEDIÁTRICO (0 A 14 AÑOS)
# ----------------------------------------------------------------

grafico_pediatricos <- data_clasificada %>%
  filter(GRUPO_EDAD_PED_ADUL == "0 a 14 Años") %>%
  generar_grafico_por_grupo(
    titulo = "GRÁFICO N°4: Casos totales de IRAG en pediátricos. Distribución de agentes virales identificados según grupo de edad",
    subtitulo = "Casos registrados en el año 2025 - UCIRAG. Hospital Avellaneda. Provincia de Tucumán"
  )
