...
Del total de casos notificados, el `r prop_casos_pediatricos`% (`r frec_casos_pediatricos`/`r total_casos_ped_adult)` fueron pacientes pediatricos y el `r prop_casos_adultos` % restante (`r frec_casos_adultos`/ `r total_casos_ped_adult`) pacientes adultos.
